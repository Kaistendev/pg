...
import { ScrollReveal } from '../hooks/ScrollAnimations';
import './AboutUs.css';

const AboutUs = () => (
  <section id="about" className="about-section">
    <Container>
      <ScrollReveal animation="fade-in-up" className="section-header text-center mb-5">
      ...
      <ScrollReveal animation="slide-in-left" className="mb-5">
        <Row>
      ...
      <ScrollReveal animation="fade-in-up" stagger={true}>
        <Row className="g-4">
          <Col md={4}>
